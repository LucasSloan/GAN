"""
Example of Generative Adversarial Networks used to approximate
...
class GAN(object):
    def __init__(self, params):
        # This defineds the generator network - it takes samples from a noise
        ...
        # the true data distribution (self.x) adn the generated samples
        # (self.z).
        #
...
def samples(model, session, data, sample_range, batch_size, num_points=10000, num_bins=100):
    """
    Return a tuple (db, pd, pg), where db is the current dicision
